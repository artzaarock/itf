...
<div class="container">
    <div class="form">
        <p class="ex1"><h1><center>What do you want to do</center></h1></p>
    </div>
...
?>
  <tr>
    ...
    <td><center><a href="formdata.html"><input type="submit" value="edite" class="btn-default"></a>&nbsp;&nbsp;<a href="formdeldata.html"><input type="submit" value="Delete"  class="btn-default"></a></center></td>
  </tr>
<?php
}
?>
